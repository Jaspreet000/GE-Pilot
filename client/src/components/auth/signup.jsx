...
const SignupComponent = () => {
  ...
  const formHandle = async (e) => {
    e?.preventDefault()
    if (formData?.pass.length >= 8 && (formData?.email.endsWith("@gmail.com") || formData?.email.endsWith("@grantengine.com"))) {
      let res = null
      try {
              ...
              !state.filled ? (
                <div className='options'>
                  <form className="manual" onSubmit={(e) => {
                    ...
                    <div>
                      <button type='submit' id="subb" >Continue</button>
                    </div>
                  </form>
                  ...
                  <div className="extra">
                    ...
                    <div id='options'>
                      <button className='goog-sub' onClick={googleAuth}><Google /> Continue with Google</button>
                    </div>
