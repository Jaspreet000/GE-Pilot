...
// Route: GET /
// Description: A simple welcome message for the root route of the ChatGPT API.
router.get("/", (req, res) => {
  res.send("Welcome to chatGPT api v1");
});

// Route: GET /upload
// Description: Fetches the file name associated with a specific chat for a logged-in user.
...
// Route: POST /upload
// Description: Uploads a file to OpenAI, stores the file ID and name in MongoDB, and updates the chat with the file details.
...
// Route: POST /
// Description: Sends a chat prompt to OpenAI and stores the response in the database.
...
// Route: PUT /
// Description: Sends a chat prompt with a specified chat history to OpenAI and stores the response in the database.
...
// Route: GET /saved
// Description: Retrieves the saved chats for a user, optionally filtered by a specific chat ID.
...
// Route: DELETE /all
// Description: Deletes all chat history for a user.
...
// Route: POST /getfile
// Description: Retrieves the list of files attached to a specific chat.
...
// Description: Deletes a specific file attached to a chat for a logged-in user.
